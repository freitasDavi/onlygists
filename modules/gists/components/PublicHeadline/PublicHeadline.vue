...
<template>
    <div class="w-full flex flex-col justify-center gap-2 my-5">
        ...
        <div v-html="description" class="font-[Inter] text-gray-700 font-regular text-base md:text-xl" />
        <p class="font-[Inter] font-regular text-gray-500 text-sm md:text-base">
            <i class="pi pi-star"></i>
            by
            <NuxtLink :to="`/${props.author}`" class="text-primary-500">@{{ props.author }}</NuxtLink>
        </p>
    </div>
</template>